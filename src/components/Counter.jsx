...
const Counter = () => {
  ...
  return (
    <div className='border rounded p-5 text-center'>
        ...
        <div style={{width:'600px'}} className="d-flex justify-content-between my-5">
        ...
        <button onClick={handleIncrementAmount} className='btn btn-primary ms-4'>Incement By Amount</button>
        </div>
    </div>
  )
}
